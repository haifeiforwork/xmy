...
//	List<EntityCoupon> findCoupon(Long userId,CouponSearchInDto couponSearchInDto);
	 ...
	 */
	List<GetAvailbleCouponOutDto> findUserCoupon(Long userId, CouponSearchInDto couponSearchInDto);
...
//	void setEntityCouponBinding(EntityCoupon entityCoupon,CouponUser couponUser);
	 ...
	 */
	List<CouponCenterOutDto> couponCenter(Long userId);
//	/**
//	 * 领券中心 (查询所有可用的优惠券)
//	 * @Description 
//	 * @param userId
...
//	Integer setEntityCouponBindingWap(EntityCoupon entityCoupon,CouponUser couponUser);
	 ...
	 */
	  ...
	  * @author wy
	  * 2017
	  * @return List<GetAvailbleCouponOutDto>
	  */
	List<GetAvailbleCouponOutDto> findUserCanUseCoupon(Long userId,
			CanUseCouponInDto canUseCouponIn);
	/**
	 * 导出优惠卷成excel表格
	 * @param couponId coupon表id
	 * @return
	 * @Description 
	 * @date 2017年12月15日  上午11:39:19
	 * @author wy
	 * 2017
	 * @return File
	 * @throws IOException 
	 */
	HSSFWorkbook exportCoupon(Long couponId, HttpServletResponse response) throws IOException;
	/**
	 * 追加优惠劵(在已有的优惠劵类别上 添加更多数量的劵)
	 * @param couponid 优惠劵类别id
	 * @param count 追加数量
	 * @Description 
	 * @date 2018年2月2日  上午10:10:09
	 * @author wy
	 * 2018
	 * @return void
	 */
	void appendMoreCoupon(Long couponid, Long count);
}
