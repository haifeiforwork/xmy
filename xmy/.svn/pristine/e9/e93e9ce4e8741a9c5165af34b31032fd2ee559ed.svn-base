package com.zfj.xmy.cms.web.common.ims.aop;
...
import com.zfj.xmy.cms.web.common.ims.util.MapUtil;
...
/*	@Pointcut("@annotation(com.myron.ims.annotation.SystemServiceLog)")
	 ...
	 * Controller层切点 注解拦截
	 */
	@Pointcut("@annotation(com.zfj.xmy.cms.web.common.ims.annotation.SystemControllerLog)")
	public void controllerAspect(){}
	
	/**
	 * 方法规则拦截
	 */
	@Pointcut("execution(* com.zfj.xmy.cms.web.controller.*.*(..))")
	...
	public void doAfter(JoinPoint joinPoint) {
    	...
    	log.setParams(MapUtil.MapToParams(params));
