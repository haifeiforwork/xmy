...
<div class="layui-layout layui-layout-admin">
 ...
 <div class="layui-tab layui-tab-brief layui-form" >
	<div class="layui-body layui-tab-content site site-body site-custom-body layui-form-item">
		<form class="layui-form"  action="supplier/updateSupplier" method="post" id="form">
			<div class="layui-form-item">
			    <label class="layui-form-label">供应商名称</label>
			    <div class="layui-input-block">
			      <input type="text" name="name" lay-verify="name" value="${termData.name }"  autocomplete="off" placeholder="单行输入" class="layui-input">
			    </div>
			</div>
			...
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			      <input type="text" name="sn" lay-verify="sn"  value="${termData.sn }" autocomplete="off" placeholder="单行输入" class="layui-input">
			    </div>
			</div>
			...
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			      <input type="checkbox"   lay-skin="switch" lay-filter="status" <c:if test="${termData.status ==0 }">checked</c:if>  lay-text="ON|OFF">
