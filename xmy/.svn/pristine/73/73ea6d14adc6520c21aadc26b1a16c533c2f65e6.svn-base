...
<div class="container container-white">
    ...
    <input type="hidden" value="${oneId }" id="goodsName" />
    ...
    <div class="list-content screen-all w-1250">
        <div class="search-content">
            ...
            <div class="area">
                <span>价格区间 : </span><input type="text" id="beginPrice"> - <input type="text" id="endPrice">
            </div>
        </div>
  ...
  <script type="text/javascript" src="resource/js/search/top_search.js"></script>
  </body>
</html>
