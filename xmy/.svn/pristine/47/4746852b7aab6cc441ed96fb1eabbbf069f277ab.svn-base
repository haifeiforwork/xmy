...
<div class="container container-white">
    ...
    <input type="hidden" value="${tName }" id="typeName" />
    ...
    <div class="list-content w-1250">
        <div class="search-content">
            ...
            <div class="result">
	            ...
	            <div hidden="hidden">
	            	<c:if test="${!empty goodsName }"><span class="keywords">${goodsName }</span><i class="iconfont">&#xe6e8;</i></c:if>
	            	<c:if test="${empty goodsName && !empty wordName}">
