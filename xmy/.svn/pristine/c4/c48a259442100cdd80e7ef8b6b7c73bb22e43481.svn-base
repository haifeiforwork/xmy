...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-tab layui-tab-brief layui-form" lay-filter="demoTitle">
  	...
  	<i class="layui-icon" style="font-size: 20px; color: #009688;">订单审核</i>
 	 		<hr>
			...
			<form id="myForm">
				...
				<div class="layui-input-inline">
			      <select name="ship_status" lay-filter="ship_status" class="q-rule" zfj-query="ship_status:eq" disabled>
			        ...
			        <option value="1" <c:if test="${params.shipStatus == 1}">selected="selected"</c:if> selected="selected">待审核</option>
			        ...
			        <option value="4" <c:if test="${params.shipStatus == 4}">selected="selected"</c:if>>备货确认</option>
				...
				<div class="layui-form-item">
					<div class="layui-input-inline" style="width: 150px">
						...
						<option value="3">批量审核通过</option>
						<option value="13">批量审核不通过</option>
						</select>
					</div>
						<div class="layui-input-inline">
  ...
  <script type="text/javascript" src="order/js/order_audit_list.js"></script>
</div>
</body>
</html>