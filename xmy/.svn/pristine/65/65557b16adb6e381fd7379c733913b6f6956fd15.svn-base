...
<div class="layui-tab-item layui-show ">
	...
	<form id="myForm">
	   <div class="layui-input-inline">
	     	<input type="text" class="q-rule layui-input " id="category" zfj-query="category_name:cn" value="${params.category_name}" placeholder="点击选择分类" name="category_name" readonly="readonly">
    </div>
		
		<div class="layui-input-inline">
     <input type="text" class="q-rule layui-input choose" data-vid="3" id="brandName" zfj-query="brand_name:cn" value="${params.brand_name}" placeholder="点击选择品牌" name="brand_name" readonly="readonly"/>
    </div>
  
    <div class="layui-input-inline">
      <input type="text" class="q-rule layui-input choose" data-vid="4" id="supplierName" zfj-query="supplier_name:cn" value="${params.supplier_name}" placeholder="点击选择供应商" name="supplier_name" readonly="readonly"/>
    </div> 
	...
	<div class="layui-input-inline">
   	 	<input type="text" class="q-rule layui-input" zfj-query="name:cn" value="${params.name}" placeholder="商品名称" name="name"/>
    </div>
