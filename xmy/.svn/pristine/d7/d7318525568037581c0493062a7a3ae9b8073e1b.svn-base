...
public class ScreenGoodsController {
	 ...
	 * @return ResponseEntity<AppResp>
	 * @author lij
	 * @date 2017年12月26日 上午9:55:55
	 */
	@RequestMapping(value="/keyList",method=RequestMethod.POST)
	@Exclusion
	public ResponseEntity<AppResp> keyList(@RequestBody AppGoodsInDto goodsInDto){
		List<String> outList = new ArrayList<>();
		List<String> list = elasticGoodsService.searchTopGoods(goodsInDto.getGoodsName());
