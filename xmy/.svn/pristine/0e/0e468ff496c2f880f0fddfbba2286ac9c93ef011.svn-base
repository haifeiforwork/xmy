...
<div class="layui-layout layui-layout-admin">
			...
			<form id="myForm">
				...
				<div class="layui-input-inline">
			      <select name="ship_status" lay-filter="ship_status" class="q-rule" zfj-query="ship_status:eq" disabled>
			        ...
			        <option value="6" <c:if test="${params.shipStatus == 6}">selected="selected"</c:if> selected="selected" >已发货</option>
  ...
  <script type="text/javascript" src="order/js/order_finish.js"></script>
</div>
</body>
</html>