...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <header>
    	<div class="header-top">
    		...
    		<div class="pull-center">余额明细</div>
    	</div>
    </header>
	<div class="content">
    	<div id="content" class="weui-form-preview">
    		<!-- <div class="weui-form-preview__bd">
			    ...
			    <div class="weui-form-preview__item">
			      	...
			      	<span class="weui-form-preview__value">34.50</span>
			    </div>
			    <div class="weui-form-preview__item">
			      	<label class="weui-form-preview__label">类型</label>
			      	<span class="weui-form-preview__value">消费</span>
			    </div>
			    <div class="weui-form-preview__item">
			    ...
			    <div class="weui-form-preview__item">
			      	...
			      	<span class="weui-form-preview__value">2017-05-03 15:01:18</span>
			    </div>
			</div>
			<div class="weui-form-preview__bd">
			    <div class="weui-form-preview__item">
    ...
    <!-- 公共js区域完 -->
    <!-- 该页面应用js区域 -->
    <script src="resources/mine/js/accountBalanceDetail.js"></script>
    <!-- 该页面应用js区域 -->
    </body>
</html>