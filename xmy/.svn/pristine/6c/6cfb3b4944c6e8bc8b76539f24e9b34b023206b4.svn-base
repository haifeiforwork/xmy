...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="resource/css/search/goods_search.css">
  </head>
...
<div class="container container-white">
    <div class="list-content recomed w-1250">
        ...
        <ul class="clearfix">
            <c:forEach items="${topGoods }" var="topgoods">
              ...
              <c:if test="${!empty topgoods.imgPath }"><img:imghandle w="122" imgurl="${topgoods.imgPathh }" h="122"  cl="shop-img"></img:imghandle></c:if>
        ...
        <div class="search-list">
            <ul>
                ...
                <li class="search-list-item clearfix">
                    ...
                    <div class="col-10" id="more">更多 <i class="iconfont">&#xe63b;</i></div>
                </li>
                </c:forEach>
                <!--  <li class="search-list-item clearfix">
    ...
    <input type="hidden" value="${countPage }" id="countPage"/>
  ...
  <script type="text/javascript" src="resource/js/search/goods_search.js"></script>
  </body>
</html>
