...
public interface PcSearchService {
	 ...
	 * @return List<PcSearchDto>
	 * @author lij
	 * @date 2017年11月27日 下午3:16:22
	 */
	List<PcSearchDto> querySearchDto(Long typeId,Long oneId,String words);
	 ...
	 */
	List<PcSearchDto> findSearchDtoByWord(Long typeId,Long wordId);
