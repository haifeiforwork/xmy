	...
	<div id="flex" class="slideBox">
		<ul class="items">
			<c:forEach items="${topImg }" var="item">
         		<li><a href="goods/${item.data }/0/0"><img src="${item.imgPath }"></a></li>
           	</c:forEach>
		</ul>
	</div>
</div>
  <div class="container add-g-b" style="margin-bottom:0;background:#EFEFEF url('resource/commons/images/page-bg.jpg') center no-repeat fixed">
        ...
        <ul class="clearfix add-bg-w">
            ...
            <a href="goods/${goods.goodsId}/0/0">
                <div class="list-show">
                    ...
                    <p class="text-elips" style="color: black;" title="${goods.goodsName }">${goods.goodsName }</p>
