...
public class GetWxOrderno
{
   ...
   */
	...
	public static WechatH5Result getPayNoAndMweburl(String url, String xmlParam) {
		Map map = getReturnMap(url, xmlParam);
		WechatH5Result h5Result = new WechatH5Result();
		if (!CollectionUtils.isEmpty(map)) {
			h5Result.setPrepay_id((String) map.get("prepay_id"));
			h5Result.setMweb_url((String) map.get("mweb_url"));
		}
		return h5Result;
	}
