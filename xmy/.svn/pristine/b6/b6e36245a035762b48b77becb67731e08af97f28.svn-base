...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-tab layui-tab-brief layui-form" lay-filter="demoTitle">
  	...
  	<i class="layui-icon" style="font-size: 20px; color: #009688;">APP下单前文字设置</i>
 	 		<hr>
 	<div class="layui-tab-item layui-show">
 	    <form id="bannerform" action="order/setAppBanner" >
 	        <div class="layui-input-inline">
			    <input type="text" class="q-rule layui-input"  value="${banner}" placeholder="横幅内容" name="banner"/>
			</div>
