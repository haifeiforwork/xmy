 ...
 */
@Service
public class WapShoppingCardRecordServiceImpl implements WapShoppingCardRecordService {
	@Autowired
	 ...
	 */
	@Override
	public void addShoppingCardRecord(String remark, Long id,BigDecimal money) {
