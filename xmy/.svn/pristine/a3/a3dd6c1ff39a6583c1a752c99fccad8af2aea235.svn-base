package com.zfj.xmy.pay.service.oldAlipay.util;
...
public class AlipaySubmit {
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName,String privateKey) {
        //待请求参数数组
