...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-tab layui-tab-brief layui-form" lay-filter="demoTitle">
  	...
  	<i class="layui-icon" style="font-size: 20px; color: #009688;">备货确认</i>
 	 		<hr>
			...
			<form id="myForm">
				...
				<div class="layui-input-inline">
			      <select name="ship_status" lay-filter="ship_status" class="q-rule" zfj-query="ship_status:eq" disabled>
			        ...
			        <option value="4" <c:if test="${params.shipStatus == 4}">selected="selected"</c:if> selected="selected">备货确认</option>
				...
				<div class="layui-form-item">
					<div class="layui-input-inline" style="width: 150px">
						...
						<option value="5">备货确认</option>
						<!-- <option value="print">批量打印客户清单</option> -->
						</select>
					</div>
						<div class="layui-input-inline">
						<button class="layui-btn" id="btnPre" lay-submit="" lay-filter="demo2">执行</button>
						</div>
				</div>
				<div id="mypager"></div>
  ...
  <script type="text/javascript" src="order/js/order_prepare_list.js"></script>
</div>
</body>
</html>