...
<div class="content">
    <div class="w-1250">
        <div class="status">
        	...
        	<input type="hidden" id="containsSpecileGoods" value="${containsSpecileGoods }">
        ...
        <div class="payment-choice">
            ...
            <input class="select" type="checkbox" value="${payOrder.id }" id="check"  ${userInfo.balance > 0 ? 'checked':'' }/>
           	...
           	<span class="pay">支付<input type="text" id="payMentyMoney" ${userInfo.balance > 0 ? '':'readonly' } value="${userInfo.balance >= payOrder.total ? payOrder.total:userInfo.balance }"/>元</span>
