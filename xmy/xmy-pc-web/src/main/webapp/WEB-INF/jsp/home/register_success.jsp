 	...
 	<div class="container">
	    ...
	    <div class="register clearfix w-1250">
	        <div class="col-50 clearfix step2">
	            ...
	            <div class="col-70">
	                <p class="first-setent">恭喜 , <span class="color-green">${name}</span> 注册成功 !</p>
	                <p class="second-setent">完善个人资料 , 让账户更安全 , 用户更放心</p>
	              <!--   <p class="third-setent"><button type="button">完善个人资料</button></p> -->
	            </div>
	        </div>
	    </div>
	    <div style="display: none;">
	    	 <form method="post" id="myform" action="user/login">
