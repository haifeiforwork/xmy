...
<html>
  ...
  <body>
 	...
 	<div class="container"  style="background-color: #fff;">
	    ...
	    <form method="post" id="myform"  style="background-color: #EFEFEF;">
	    <div class="register clearfix w-1250"  style="background-color: #fff;">
	        <div class="form-group col-50 clearfix">
	            <label for="name">用户名</label><div class="wrap-input clearfix"><input type="text" placeholder="请输入手机号作为用户名" name="name" id="name" required></div>
	        </div>
	        <div class="form-group col-50 clearfix">
	            <label for="password">登录密码</label><div class="wrap-input clearfix"><input type="password" placeholder="请输入登录密码" name="password" id="password" required></div>
	        </div>
	        <div class="form-group col-50 clearfix">
	            <label for="again_password">确认密码</label><div class="wrap-input clearfix"><input type="password" placeholder="请确认密码" name="againPassword" id="again_password" required></div>
	        </div>
	        <div class="form-group col-50 clearfix">
	        ...
	        <div class="form-group col-50 clearfix">
	            <div class="wrap-input wp-add"><button type="button" class="toregister" id="register">立即注册</button></div>
	        </div>
	    </div>
	...
	<script type="text/javascript" src="resource/js/home/register.js"></script>
  </body>
</html>
