            ...
            <div class="category">
                ...
                <div class="category-content">
                    ...
                    <div class="paging btn-group">
                        <button type="button" style="cursor: pointer;" class="btn-default btn-top" onclick="window.location='/center/toCouponSort?pageIndex=1&set=11&sort=${status}''">首页</button>
                        <c:if test="${pageBean.pageIndex==1}">
                        	<button type="button" style="cursor: pointer;" class="btn-default btn-prevee">上一页</button>
                        </c:if>
                        <c:if test="${pageBean.pageIndex!=1}">
                        	<button type="button" style="cursor: pointer;" class="btn-default btn-prevee" onclick="window.location='/center/toCouponSort?pageIndex=${pageBean.pageIndex-1}&set=11&sort=${status}'">上一页</button>
                        </c:if>
                        ...
                        <c:if test="${pageBean.pageIndex!=pageBean.totalPage&&pageBean.totalPage!=0 }">
                        	<button type="button" style="cursor: pointer;" class="btn-default btn-nextt" onclick="window.location='/center/toCouponSort?pageIndex=${pageBean.pageIndex+1}&set=11&sort=${status}'">下一页</button>
                        </c:if>
                        <button type="button" style="cursor: pointer;" class="btn-default btn-last" onclick="window.location='/center/toCouponSort?pageIndex=${pageBean.totalPage }&set=11&sort=${status}'">末页</button>
                    </div>
                    </c:if>
                </div>
            </div>
