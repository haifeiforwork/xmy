$(function($){
	...
	//冰点价
	window.setInterval(function(){icActivityTime($("#iceActivityEndTime").val(),'#iceActivityTime');}, interval);
	//天天特价
	window.setInterval(function(){activityTime($("#daydayActivityEndTime").val(),'#daydayActivityTime');}, interval);
	//买即赠
