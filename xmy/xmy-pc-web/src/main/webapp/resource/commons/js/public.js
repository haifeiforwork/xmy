$(function(){
    ...
    /*$("#title").mousedown(function(e){ 
		...
		$(document).bind("mousemove",function(ev){ 
			...
			$(".dialog-box").stop().animate({left:_x+"px",top:_y+"px"},10); 
		}); 
	}); 
	...
	function MoveDiv(id){
		 // 获取DOM元素
        var oDialog_title = document.getElementById('title');  // 允许点击鼠标获取拖拽事件区域
	...
	function qian_place(){
		...
		var ww_height = $(window).height();
		var qian_width = $(".dialog-box").width();
		var qian_height = $(".dialog-box").height();
		$(".dialog-box").css({'top':(ww_height-qian_height)/2,'left':(ww_width-qian_width)/2})
	};
	...
	$(document).ready(function () {
        $(".classify-ul").on("mouseover",".classify-li",function () {
			...
			if(size>3 && size <6){
				...
				if(size==5){
					$(this).find(".meau-content").find(".meau-item").eq(3).css({"position":"absolute","top":"16px","right":"0"});
					$(this).find(".meau-content").find(".meau-item").eq(4).css({"position":"absolute","top":"125px","right":"0"});
				}
			...
			if(size == 6){
				$(this).find(".meau-content").find(".meau-item").eq(3).css({"position":"absolute","top":"16px","right":"0"});
				$(this).find(".meau-content").find(".meau-item").eq(4).css({"position":"absolute","top":"125px","right":"0"});
				$(this).find(".meau-content").find(".meau-item").eq(5).css({"position":"absolute","top":"235px","right":"0"});
				$(this).find(".meau-content").css("width",2*miWeight);
			}
			if(size >6 && size<9){
				if(size==7){
					$(this).find(".meau-content").find(".meau-item").eq(3).css({"position":"absolute","top":"16px","right":"280px"});
					$(this).find(".meau-content").find(".meau-item").eq(4).css({"position":"absolute","top":"125px","right":"280px"});
					$(this).find(".meau-content").find(".meau-item").eq(5).css({"position":"absolute","top":"235px","right":"280px"});
				...
				if(size==8){
					...
					$(this).find(".meau-content").find(".meau-item").eq(5).css({"position":"absolute","top":"235px","right":"280px"});
					$(this).find(".meau-content").find(".meau-item").eq(6).css({"position":"absolute","top":"16px","right":"0"});
					$(this).find(".meau-content").find(".meau-item").eq(7).css({"position":"absolute","top":"125px","right":"0"});
				}
			...
			if(size ==9){
				...
				$(this).find(".meau-content").find(".meau-item").eq(6).css({"position":"absolute","top":"16px","right":"0"});
				$(this).find(".meau-content").find(".meau-item").eq(7).css({"position":"absolute","top":"125px","right":"0"});
				$(this).find(".meau-content").find(".meau-item").eq(8).css({"position":"absolute","top":"235px","right":"0"});
				$(this).find(".meau-content").css("width",3*miWeight);
			}
           /* if(size >= 3 && size<= 6){
                $(this).find(".meau-content").css("width",2*miWeight);
