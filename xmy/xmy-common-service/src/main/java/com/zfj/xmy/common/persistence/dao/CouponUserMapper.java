...
public interface CouponUserMapper {
     ...
     * 参数:查询条件,null为整张表
     * 返回:查询个数
     * @ibatorgenerated 2017-08-04 11:39:34
     */
     ...
     * @ibatorgenerated 2017-08-04 11:39:34
     */
    List<CouponUser> selectByExample(CriteriaParameter example);
     ...
     * @ibatorgenerated 2017-08-04 11:39:34
     */
    int updateByExampleSelective(@Param("record") CouponUser record, @Param("example") CriteriaParameter example);
     ...
     * @ibatorgenerated 2017-08-04 11:39:34
     */
    int updateByExample(@Param("record") CouponUser record, @Param("example") CriteriaParameter example);
     ...
     * @ibatorgenerated 2017-08-04 11:39:34
     */
    List<CouponUser> selectByExampleAndPage(CriteriaParameter example, RowBounds rowBound);
