...
public interface ShoppingCardMapper {
     ...
     * 参数:查询条件,null为整张表
     * 返回:查询个数
     * @ibatorgenerated 2017-08-21 15:08:14
     */
     ...
     * @ibatorgenerated 2017-08-21 15:08:14
     */
    List<ShoppingCard> selectByExample(CriteriaParameter example);
     ...
     * @ibatorgenerated 2017-08-21 15:08:14
     */
    int updateByExampleSelective(@Param("record") ShoppingCard record, @Param("example") CriteriaParameter example);
     ...
     * @ibatorgenerated 2017-08-21 15:08:14
     */
    int updateByExample(@Param("record") ShoppingCard record, @Param("example") CriteriaParameter example);
     ...
     * @ibatorgenerated 2017-08-21 15:08:14
     */
    List<ShoppingCard> selectByExampleAndPage(CriteriaParameter example, RowBounds rowBound);
     ...
     * @ibatorgenerated 2017-08-21 15:08:14
     */
    ShoppingCard selectByPrimaryKey(Long id);
