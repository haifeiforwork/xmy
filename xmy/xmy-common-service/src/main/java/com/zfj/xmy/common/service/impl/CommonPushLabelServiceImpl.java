...
public class CommonPushLabelServiceImpl implements CommonPushLabelService {
	...
	public List<JiguangPushLabel> getJiguangPushLabelList(CriteriaParameter para, PageBean pageBean) {
		int totalCount = jiguangPushLabelMapper.countByExample(para);
		pageBean.setTotalCount(totalCount);
		List<JiguangPushLabel> pushLabels = jiguangPushLabelMapper.selectByExampleAndPage(para, pageBean.getRowBounds());
		pageBean.setData(pushLabels);
		return pushLabels;
	}
