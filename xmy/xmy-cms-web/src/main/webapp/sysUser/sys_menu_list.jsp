...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-tab layui-tab-brief" lay-filter="demoTitle">
  	...
  	<div id="addMenu" style="display: none">
		<form class="layui-form" action="sysUser/addMenu">
    		...
    		<div class="layui-form-item">
			 ...
			 <div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			      <input type="text" name="iconUrl" autocomplete="off"  placeholder="图片" class="layui-input">
			    </div>
			 </div>
  ...
  <script type="text/javascript" src="sysUser/js/sys_menu_list.js"></script>
</div>
</body>
</html>