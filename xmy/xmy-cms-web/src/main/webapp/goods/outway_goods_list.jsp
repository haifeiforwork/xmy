			...
			<div class="layui-tab-item layui-show ">
				<form id="myForm">
				   <div class="layui-input-inline">
					...
					<%-- <div class="layui-input-inline">
			    	 	<input type="text" class="q-rule layui-input" zfj-query="keyword:cn" value="${params.keyword}" placeholder="关键词" name="keyword"/>
			        </div> --%>
					
					<input type="submit" class="layui-btn btn-submit" value="提交"  />
					<input type="button" class="layui-btn" id="reset" value="重置"  />
					<input type="button" class="layui-btn" value="导出"  />
				</form> 
			</div>	
