...
<!-- 公共css完区域 -->
<!-- 该页面应用css区域 -->
<link href="resources/border/css/border.css" rel="stylesheet">
<!-- 该页面应用css区域 -->
</head>
<body ontouchstart>
	<header>
		<div class="header-top">
			...
			<div class="pull-center">
				<img src="resources/border/images/kj-title.png" alt=""
					class="jx-title">
			</div>
			...
			<c:forEach items="${data.containers  }" var="list" varStatus="idx">
				<div class="jx">
					<div class="title-line">
						...
						<span class="more" category_id="${list.categoryId}">更多<img
	...
	<!-- 公共js区域完 -->
	<!-- 该页面应用js区域 -->
	<script type="text/javascript" src="resources/border/js/border.js"></script>
	<!-- 该页面应用js区域 -->
</body>
</html>