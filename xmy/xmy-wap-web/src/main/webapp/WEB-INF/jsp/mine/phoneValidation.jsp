    ...
    <div class="container container-white">
        <div class="weui-msg">
            ...
            <div class="weui-cells self-cell weui-cells_form">
            	<form action="mine/bindPhone" id="bindPhoneForm" method="post">
	                <div class="weui-cell">
	                    <div class="weui-cell__hd"><img src="resources/common/images/btn-login-phone@2x.png" alt="" class="hd-img"></div>
	                    <div class="weui-cell__bd"><input type="text" id="phone" name="phone" class="weui-input" placeholder="手机号"></div>
	                    <div class="weui-cell__ft get-code"><button type="button" id="getPhoneValidationCode">获取验证码</button></div>
	                </div>
	                <div class="weui-cell">
	                    <div class="weui-cell__hd"><img src="resources/common/images/btn-reg-yzm@2x.png" alt="" class="hd-img"></div>
	                    <div class="weui-cell__bd"><input type="password" id="password" name="password" class="weui-input" placeholder="请输入密码"></div>
	                </div>
	                <div class="weui-cell">
	                    <div class="weui-cell__hd"><img src="resources/common/images/btn-reg-yzm@2x.png" alt="" class="hd-img"></div>
            ...
            <div class="weui-msg__opr-area">
                <p class="weui-btn-area self-btn-area">
                    <a href="javascript:;" class="weui-btn weui-btn_primary" id="bindPhone">绑定</a>
                </p>
            </div>
