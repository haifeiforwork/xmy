	...
	<div class="content" style="bottom: 55px;">
		<form action="order/addOrder" method="post" id="confirmOrderForm">
	    	...
	    	<div class="weui-panel__bd list">
	    		...
	    		<c:set var="goodspoints" value="0"></c:set>
					<c:forEach items="${cartList }" var="goods" varStatus="status">
						<a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
			                ...
			                <div class="weui-cell__ft">
			                    <p class="money">
			                    	<c:if test="${not empty goods.sumPoints && goods.sumPoints != 0 }">
			                         	${goods.sumPoints }积分
			                        </c:if>
			                        <c:if test="${empty goods.sumPoints || goods.sumPoints==0 }">
	        ...
	        <div class="weui-cells address">
	            ...
	            <c:if test="${out==1 }">
		            <a class="weui-cell add weui-cell_access" href="javascript:;" >
		                ...
		                <div class="weui-cell__ft"><input class="time" readonly="readonly" name="postTime" id="postTime" type="text" placeholder="请选择配送时间" value="${nextDay }"/></div>
		            </a>
		         </c:if>
	            <a class="weui-cell add weui-cell_access" href="javascript:;">
	                <div class="weui-cell__bd">
			...
			<a class="weui-cell add invoiceDiv" href="javascript:;">
	            ...
	            <div style="display: none" class="near-content" id="invoiceContent">
		            <a class="weui-cell add weui-cell_access titket-pick" href="javascript:;">
		                ...
		                <div class="weui-cell__ft"><input type="text" unselectable="on" readonly="readonly" onfocus="this.blur()" placeholder="请选择" id="noteName"/></div>
		            </a>
		            <a class="weui-cell add " href="javascript:;">
		                <div class="weui-cell__bd">
		                    <p>发票内容</p>
	        ...
	        <div class="weui-form-preview__bd chunk">
	            <div class="weui-form-preview__item">
	                <label class="weui-form-preview__label">商品总金额（含税）</label>
	            ...
	            <div class="weui-form-preview__item">
	                <label class="weui-form-preview__label">可获积分</label>
	                <span class="weui-form-preview__value gray"><fmt:formatNumber value="${sumPrice - 0.4}" pattern="#"/></span>
	            </div>
	            <div class="weui-form-preview__item">
	                <label class="weui-form-preview__label">消耗积分</label>
	            ...
	            <div class="weui-form-preview__item">
	                <label class="weui-form-preview__label">优惠抵用券</label>
...
<%-- 			    <a class="weui-cell wrap ad-gutter weui-cell_access tiket-pick">
	        ...
	        <c:if test="${not empty preoreadBanner}">
	        	<div class="weui-form-preview__bd chunk" style="margin-bottom: 0.25rem;text-align: center;line-height: 1;">
	        		<span style="color:red;font-weight: bolder;font-size: 14px;">${preoreadBanner }</span>
	        	</div>
	        </c:if>
	        ...
	        <input type="hidden" name="accPoints" value="<fmt:formatNumber value="${sumPrice - 0.4}" pattern="0"/>"/>
        </form>
   	</div>
   	<!-- 隐藏值 -->
   	<input type="hidden" id="sumPrice" value="${sumPrice }">
   	<input type="hidden" id="postHiddenPrice" value="${postPrice }" />
   	...
   	<input type="hidden" id="goodsAllpoint" value="${sumPoints }">
	<input type="hidden" id="accpoint" value="${accPoints }"/>
	<!-- 隐藏值 -->
    <footer>
        <div class="row">
            <div class="ly-65">应付总金额:<span class="sumPriceShow">￥${salePrice + postPrice}</span></div>
	...
	<div id="coupon_popup" class="weui-popup__container popup-bottom" style="z-index: 999">
	  ...
	  <div class="weui-popup__modal open-popup add_address_content" data-target="" style="height: 100%;">
	  	<header>
					...
					<div class="lump">
						<div class="lump1">
							<div class="weui-panel weui-panel_access">
								<div class="weui-panel__bd coupon-list">
								</div>
							</div>
						</div>
					</div>
			...
			<footer>
				<a href="javascript:;" class="weui-btn weui-btn_primary slef-btn_primary close-popup notUse coupon">不使用</a>
			</footer>
	  </div>
	</div>
<div id="tiket-pop" class="weui-popup__container">
    ...
    <div class="weui-popup__modal">
        ...
        <footer>
			<a href="javascript:;" class="weui-btn weui-btn_primary slef-btn_primary close-popup tick">不需要</a>
		</footer>
    </div>
</div>
