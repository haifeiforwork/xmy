...
<div id="sign-details-modal" class="weui-popup__container">
  ...
  <div class="weui-popup__modal">
    ...
    <div class="word-btn-wrap">
    	<button type="button" class="word-btn agree" style="background:#358812;color:FFF;font-size: 0.7rem;">同意</button>
    	<button type="button" class="word-btn refuse" style="background:#ddd;color:#FFF;font-size: 0.7rem;">返回</button>
    </div>
  </div>
</div>
