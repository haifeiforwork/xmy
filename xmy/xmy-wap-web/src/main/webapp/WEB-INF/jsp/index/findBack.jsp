    ...
    <div class="container container-white">
        <div class="weui-msg">
            ...
            <div class="weui-cells self-cell weui-cells_form">
            	<form action="index/findBack" id="findBackForm" method="post">
	                <div class="weui-cell">
	                    <div class="weui-cell__hd"><img src="resources/common/images/btn-login-phone@2x.png" alt="" class="hd-img"></div>
	                    <div class="weui-cell__bd"><input type="text" id="phone" name="mobilePhone" class="weui-input" placeholder="请输入手机号"></div>
	                    <div class="weui-cell__ft get-code"><button type="button" id="sendSms">获取验证码</button></div>
	                </div>
	                <div class="weui-cell">
	                    <div class="weui-cell__hd"><img src="resources/common/images/btn-reg-yzm@2x.png" alt="" class="hd-img"></div>
	                    <div class="weui-cell__bd"><input type="text" id="phoneCode" name="code" class="weui-input" placeholder="请输入验证码"></div>
	                </div>
	                <div class="weui-cell">
	                    <div class="weui-cell__hd"><img src="resources/common/images/btn-login-pw@2x.png" alt="" class="hd-img"></div>
	                    <div class="weui-cell__bd"><input type="password" id="pass" name="password" class="weui-input" placeholder="新密码"></div>
	                    <div class="weui-cell__ft js-bd js-bd2"></div>
	                </div>
	                <div class="weui-cell">
	                    <div class="weui-cell__hd"><img src="resources/common/images/btn-login-pw@2x.png" alt="" class="hd-img"></div>
	                    <div class="weui-cell__bd"><input type="password" id="rePass" class="weui-input" placeholder="重复新密码"></div>
	                    <div class="weui-cell__ft js-bd js-bd2"></div>
	                </div>
                </form>
            </div>
            <div class="weui-msg__opr-area">
                <p class="weui-btn-area self-btn-area">
                    <a href="javascript:;" class="weui-btn weui-btn_primary" id="findBackBtn">找回</a>
                </p>
            </div>
