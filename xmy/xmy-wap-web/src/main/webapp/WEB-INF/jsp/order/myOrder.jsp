	...
	<div class="content">
    	...
    	<div class="head">
    		<div class="weui-flex order-status">
			 	...
			 	<div class="weui-flex__item chunk6">历史订单</div>
			</div>
    	</div>
    	<div class="mian">
    		<div class="lump1">
    		...
    		<c:if test="${!empty allOrder }">
				...
				<div class="chunk">
					<div class="title">
						...
						<c:if test="${order.isDel == 0 }"><span class="state">已取消</span></c:if>
					...
					<c:forEach items="${order.orderGoods }" var="goods">
						<input type="hidden" value="${goods.goodsId }" name="goodsId" class="goodsId" />
					</c:forEach>
							...
							<a  class="weui-media-box weui-media-box_appmsg">
								    ...
								    <div class="weui-media-box__bd">
								        ...
								        <c:if test="${empty orderGoods.sumPoints || orderGoods.sumPoints == 0}">
								        	￥<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2">${orderGoods.sumPrice }</fmt:formatNumber>
								        </c:if>
								        </p>
								    </div>
