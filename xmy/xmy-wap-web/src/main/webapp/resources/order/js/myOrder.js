require(["common"],function(){
    	...
    	//根据不同状态查询订单列表
    	$(".order-status").on("click",".weui-flex__item:not(.chunk6)",function(){
    		var userId=$(".userId").val();
    		window.location.href = "order/myOrder/"+ $(this).attr("status") +"?set="+userId;
    	});
    	
    	//历史订单
    	$(".chunk6").click(function(){
    		console.info("aaaa");
    		window.location.href = "http://mjk.xmy365.com/subject/wap_order/wap_order.html?number=106";
    	}) ;
